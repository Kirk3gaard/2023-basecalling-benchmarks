...
Pod5 data:
NCBI will not accept this format. Trying to convince ENA to accept it ([https://github.com/enasequence/read_docs/issues/129](https://github.com/enasequence/read_docs/issues/129)). 
...
```{r fig.width=10,fig.height=7,echo=FALSE,warning=FALSE,message=FALSE}
NP_QC_combined %>% ggplot(aes(x = percentIdentity,col=REF))+geom_density()+geom_vline(xintercept = 99,col="red",linetype="dashed")+facet_wrap(~model,ncol = 1,scales = "free_y")+coord_cartesian(xlim=c(95, 100))+xlab("Percent identity")
```
