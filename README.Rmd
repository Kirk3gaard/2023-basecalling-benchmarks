...
NP_QC_combined %>% group_by(basecalling_model,model_version,REF) %>% filter(percentIdentity==100) %>% filter(lengths==aligned_lengths) %>% filter(lengths==max(aligned_lengths)) %>% 
