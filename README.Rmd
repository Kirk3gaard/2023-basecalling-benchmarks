...
The data has been added to the NCBI-SRA [PRJNA934154](https://www.ncbi.nlm.nih.gov/bioproject/PRJNA934154). I have managed to upload the fastq and the fast5 files. However, I am still not sure how to find the page where the fast5 data can be downloaded. The fastq files should be available through the "cloud delivery service".
